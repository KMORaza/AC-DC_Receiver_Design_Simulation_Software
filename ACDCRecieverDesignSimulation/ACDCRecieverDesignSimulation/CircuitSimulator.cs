        ...
        public SimulationResult RunSimulation()
        {
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                if (switchDevice != null)
                {
                    ...
                    powerSum += switchDevice.CalculateConductionLoss(loadCurrent) * dt;
                    powerSum += switchDevice.CalculateSwitchingLoss(loadCurrent, rectifiedVoltage, parameters.PWM_CarrierFrequency) * dt;
                }
