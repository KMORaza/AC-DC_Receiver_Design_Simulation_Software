...
namespace ACDCSimulator
{
    public class CircuitSimulator
    {
        ...
        public SimulationResult RunSimulation()
        {
            ...
            result.DeviceTemperature = 25; // Ambient temperature
            result.DeviceEfficiency = 100; // 100% efficiency
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                if (switchDevice != null)
                {
                    ...
                    powerSum += conductionLoss * dt;
                    powerSum += switchingLoss * dt;
